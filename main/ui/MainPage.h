...
#define DEFAULT_DEMO_STATE  (DEMO_FIRE | DEMO_METABALLS | DEMO_DEFORM | DEMO_ROTOZOOM)
// #define DEFAULT_DEMO_STATE  (DEMO_FIRE | DEMO_DEFORM | DEMO_ROTOZOOM)
// #define DEFAULT_DEMO_STATE  (DEMO_METABALLS | DEMO_DEFORM | DEMO_ROTOZOOM)
